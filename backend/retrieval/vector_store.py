...
class LexFusionVectorStore:
    ...
    def __init__(self):
        ...
        # We explicitly create (or get) the collection on the raw client first,
        # which forces ChromaDB to initialise its internal SQLite schema tables
        # before langchain-chroma touches them — avoiding the
        # "no such table: collections" bug that occurs when Chroma queries
        # the schema before it has been written.
